                ...
                {step === 1 && (
                  <div className="space-y-4 animate-fade-in">
                    ...
                    <div>
                      ...
                      <input {...register('companyName')} className="input" placeholder="Banda Corporation Ltd" />
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-0">
                        ...
                        <input {...register('tenantSlug')} className="input rounded-l-none" placeholder="banda-corp" />
                      </div>
